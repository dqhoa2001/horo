...
<head>
    ...
    <link rel="stylesheet" href="{{ public_path('/assets/css/pdf3.css') }}">
    <link rel="stylesheet" href="{{ public_path('/assets/css/a4print.css') }}">
...
<body>
    <div class="basewidth">
        ...
        @if ($explain->get('MOON')->get('aspect_pattern')->forget([0,1,2])->values()->count() > 0)
            @php
                $items = $explain->get('MOON')->get('aspect_pattern')->forget([0,1,2])->values();
        ...
        @if ($explain->get('MERCURY')->get('aspect_pattern')->forget([0,1,2])->values()->count() > 0)
            @php
                $items = $explain->get('MERCURY')->get('aspect_pattern')->forget([0,1,2])->values();
                $itemPairs = array_chunk($items->all(), 4);
            @endphp
            @foreach($itemPairs as $itemPair)
            @if ($itemPair[0] !== null)
        ...
        @if ($explain->get('VENUS')->get('aspect_pattern')->forget([0,1,2])->values()->count() > 0)
            @php
                $items = $explain->get('VENUS')->get('aspect_pattern')->forget([0,1,2])->values();
                $itemPairs = array_chunk($items->all(), 4);
            @endphp
            @foreach($itemPairs as $itemPair)
            @if ($itemPair[0] !== null)
        ...
        @if ($explain->get('SUN')->get('aspect_pattern')->forget([0,1,2])->values()->count() > 0)
            @php
                $items = $explain->get('SUN')->get('aspect_pattern')->forget([0,1,2])->values();
                $itemPairs = array_chunk($items->all(), 4);
            @endphp
            @foreach($itemPairs as $itemPair)
            @if ($itemPair[0] !== null)
        ...
        @if ($explain->get('MARS')->get('aspect_pattern')->forget([0,1,2])->values()->count() > 0)
            @php
                $items = $explain->get('MARS')->get('aspect_pattern')->forget([0,1,2])->values();
                $itemPairs = array_chunk($items->all(), 4);
            @endphp
            @foreach($itemPairs as $itemPair)
            @if ($itemPair[0] !== null)
        ...
        @if ($explain->get('JUPITER')->get('aspect_pattern')->forget([0,1,2])->values()->count() > 0)
            @php
                $items = $explain->get('JUPITER')->get('aspect_pattern')->forget([0,1,2])->values();
                $itemPairs = array_chunk($items->all(), 4);
            @endphp
            @foreach($itemPairs as $itemPair)
            @if ($itemPair[0] !== null)
        ...
        @if ($explain->get('SATURN')->get('aspect_pattern')->forget([0,1,2])->values()->count() > 0)
            @php
                $items = $explain->get('SATURN')->get('aspect_pattern')->forget([0,1,2])->values();
                $itemPairs = array_chunk($items->all(), 4);
            @endphp
            @foreach($itemPairs as $itemPair)
            @if ($itemPair[0] !== null)
