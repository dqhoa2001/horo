...
<body>
    <div class="basewidth">
        ...
        <div class="page page5 page--number page--number_left" data-pageno="{{ $page++ }}">
            <div class="page__inner">
                <p class="page5__title"><span>YOUR SOLAR HOROSCOPE</span></p>
        ...
        <div class="page page24 page--content page--sun page--number page--number_left"
            ...
            <div class="page__inner">
                <div class="page-block page-block--1">
                    ...
                    <p class="page__text">
                        <span style="text-indent: 0;">{!! nl2br($explain->get('SUN')->get('zodiac_pattern')->content_solar) !!}</span>
                    </p>
                </div>
                <div class="page-block page-block--2">
                ...
                <div class="page-block page-block--3">
                    ...
                    @else
                        <p class="page-block--3__title">
                            ...
                            度「{{ $explain->get('SUN')->get('sabian_pattern')->title_solar }}」</p>
                        <p class="page__text">
                            <span style="text-indent: 0;">{!! nl2br($explain->get('SUN')->get('sabian_pattern')->content_solar) !!}</span>
                        </p>
                    @endif
                </div>
            </div>
        ...
        <div class="page page40 page--content page--dragonhead page--number page--number_left"
            ...
            <div class="page__inner">
                <div class="page-block page-block--1">
                    ...
                    <p class="page__text">
                        <span style="text-indent: 0;">{!! nl2br($explain->get('CHIRON')->get('zodiac_pattern')->content_solar) !!}</span>
                    </p>
                </div>
                <div class="page-block page-block--4">
                    <p class="page-block--4__title">
                    ...
                    <p class="page__text">
                        <span style="text-indent: 0;">{!! nl2br($explain->get('CHIRON')->get('house_pattern')->content_solar) !!}</span>
                    </p>
                </div>
            </div>
        </div>
