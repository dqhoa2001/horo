...
<body>
        ...
        <div class="page page7 page--cover page--cover-foot page--number page--number_right"
            ...
            <div class="page__inner" style="height: 460px;">
                ...
                <div class="page--cover-block1">
                    ...
                    <p class="page__text">
                        <span> アセンダントとはソーラーリターンの瞬間の東の地平線の位置をさし、ここにある星座(サイン)が、あなたの一年の無意識的な行動パターンとしてあらわれやすくなります。</span>
    ...
    <div class="page page25 page--content page--sun page--number page--number_right"
        ...
        <div class="page__inner">
            ...
            <div class="page-block page-block--2">
                ...
                <p class="page__text">
                    <span> 太陽が他の天体とどうかかわっているかがこの一年を読み解く重要なカギになります。一つひとつ丁寧に読み解いて、自分がやりたいことと比較し、進むヒントにしてください。</span>
                </p>
            </div>
    ...
    <!-- check item -->
    @if ($explain->get('SUN')->get('aspect_pattern')->forget($showKeys)->values()->count() > 0)
        @php
            $items = $explain->get('SUN')->get('aspect_pattern')->forget($showKeys)->values();
    ...
    <div class="page-break-before"></div>
        ...
        <div class="page page10 page--cover page--moon page--number page--number_right"
            ...
            <div class="page__inner">
                ...
                <div class="page--cover-block1">
                    ...
                    <p class="page__text">
                        <span> 月は、この一年の心の状況や私生活をあらわします。生まれたときとは全く違う星座であることが多く、ソーラーリターンでは、この年のあなたの精神的な中心テーマが月のサインやハウスにあらわれますので、とても重要です。</span>
                        <span> どんなことに気持ちが向かうか、感受性にどんな変化があるか、健康や暮らし、私生活全般がどんなふうになりそうかがあらわれています。</span>
                        <span> 月の配置が豊かだと、暮らしや気持ちが安定する一年であることがわかりますし、月の配置が厳しいときは、実際に精神的に厳しいことが起こりやすいと暗示されます。</span>
                    </p>
                </div>
        ...
        <div class="page page11 page--content page--number page--number_left page--moon"
            ...
            <div class="page__inner">
                ...
                <div class="page-block page-block--2">
                    ...
                    <p class="page__text">
                        <span> この一年、暮らしや心の中であなたが抱くテーマを具体的にあらわします。サビアンシンボルが示すような体験や気づきがあるでしょう。</span>
                    </p>
                </div>
        ...
        <div class="page page12 page--content page--number page--number_right page--moon"
            ...
            <div class="page__inner">
                ...
                <div class="page-block page-block--2">
                    <p class="page-block--2__title">アスペクト<span>他の天体との関わりからわかること</span></p>
                    <p class="page__text">
                        <span> 暮らしそのものにストレスが多いか、楽しみや癒しが多いかといったことは、月とのアスペクトにあらわれている場合が多くなります。</span>
                    </p>
                </div>
            ...
            <div class="page-block page-block--5">
                @if ($explain->get('MOON')->get('aspect_pattern')->isNotEmpty())
                    @foreach ($explain->get('MOON')->get('aspect_pattern') as $key => $item)
                        ...
                        @else
                            @switch(true)
                                @case($key01MaxLength > 200  &&  $key01MaxLength <= 350)
                                    @php $show = ($key23MaxLength <= 200) ? 3 : 2; @endphp
                                    @if ($key < $show)
                                        <div class="page-block--5__half">
                                            <p class="planet page-block--5__title icon-sign icon-sign" style="font-size: 16px !important">
                                                <span>{{ $item->fromPlanet->symbol }}</span> 
                                    ...
                                    @break
                                <!-- dang test case nay -->
                                @case($key01MaxLength <= 200 && $key01MaxLength >= 50 )
                                    @php $show = ($key23MaxLength <= 250) ? 4 : 3; @endphp
                                    @if ($key < $show)
                                        <div class="page-block--5__half">
                                            <p class="planet page-block--5__title icon-sign icon-sign" style="font-size: 16px !important">
                                                <span>{{ $item->fromPlanet->symbol }}</span> 
                                    ...
                                    @endif    
                                    @break
                                @case($key01MaxLength < 50)
                                    @php $show = ($key23MaxLength <= 350) ? 4 : 3; @endphp
                                    @if ($key < $show)
                                        <div class="page-block--5__half">
                                            <p class="planet page-block--5__title icon-sign icon-sign" style="font-size: 16px !important">
                                                <span>{{ $item->fromPlanet->symbol }}</span> 
        ...
        @if ($explain->get('MOON')->get('aspect_pattern')->forget($showKeys)->values()->count() > 0)
            @php
                $items = $explain->get('MOON')->get('aspect_pattern')->forget($showKeys)->values();
                $itemPairs = array_chunk($items->all(), 4);
            @endphp
            @foreach($itemPairs as $itemPair)
            @if ($itemPair[0] !== null)
        ...
        <div class="page page15 page--cover page--mercury page--number page--number_right"
            ...
            <div class="page__inner">
                ...
                <div class="page--cover-block1">
                    ...
                    <p class="page__text">
                        <span> 水星からはこの一年、あなたが何に関心を示し、何を学ぼうとし、どのような交友関係を結ぶのかといったことがわかります。</span>
                        <span> 水星は太陽のそばにあることが多いため、出生図と同じ星座になることも多いでしょうし、生まれた時の位置の前後の星座に入っていることもあるでしょう。出生図の水星と同じ星座の場合は普段通り、違う場合は、知的な関心ごとや言葉で表現したいことのテーマがいつもと違う年になることがわかります。</span>
                        <span>  ハウスやサビアンシンボル、水星へのアスペクトは毎年異なりますから、知的な成長や学びがその年ごとに刷新されていきます。</span>
                        <span> また、太陽があらわす目的意識を達成するために、知性やコミュニケーション能力をどう活かすといいかが示されていると考えるといいでしょう。</span>
                    </p>
                </div>
        ...
        <div class="page page16 page--content page--mercury page--number page--number_left"
            ...
            <div class="page__inner">
                ...
                <div class="page-block page-block--2">
                    ...
                    <p class="page__text">
                        <span> この一年の知的な関心ごとやテーマが具体的にわかります。サビアンシンボルには、知識や認知的な領域で変わったり獲得していくテーマが示されています。</span>
                    </p>
                </div>
                <div class="page-block page-block--3">
        ...
        <div class="page page19 page--cover page--venus page--number page--number_right"
            ...
            <div class="page__inner">
                ...
                <div class="page--cover-block1">
                    ...
                    <p class="page__text">
                        <span> 地球から見て金星は、太陽から約47度までしか離れませんので、生まれた時の星座と同じ場所に金星があることも多いですが、異なる場合もあります。同じ場合は、好きなことや楽しみごとにあまり変化がないともいえますし、星座が異なるときにはその質が変化することがわかります。</span>
                        <span> それ以外にも、サビアンシンボルからはあなたが今年獲得する楽しみや喜びがどんなものなのかを具体的に知ることができますし、ハウスやアスペクトでどんなふうに感受性が豊かに育まれるのか、魅力をどう打ち出していくことができそうか、などがあらわれています。</span>
                        <span> ソーラーリターンの場合は太陽があらわす目的意識を成し遂げるために使われる意味として読んでいくため、私生活ではなく仕事でこの感性が活かされるか、仕事で楽しみが多いか、といったことがわかると考えます。</span>
                        <span> 社会であなたの魅力を表現するためにとても重要です。</span>
                    </p>
                </div>
        ...
        <div class="page page20 page--content page--venus page--number page--number_left"
            ...
            <div class="page__inner">
                ...
                <div class="page-block page-block--2">
                    ...
                    <p class="page__text">
                        <span>この一年、どんなことが楽しいのか、どんな能力を得ることで魅力を高めるのか、といったことが具体的に示されています。</span>
                    </p>
                </div>
                <div class="page-block page-block--3">
        ...
        <div class="page page27 page--cover page--mars page--number page--number_right"
            ...
            <div class="page__inner">
                ...
                <div class="page--cover-block1">
                    ...
                    <p class="page__text">
                        <span> この一年、自分がどんなことに情熱を注ぐか、同時にどんなことに怒りを感じやすいかがあらわれています。生まれたときとは全く違う場所に位置していることが多く、どんなことのために行動し、何を得ようとするのかがわかります。何かを成し遂げるためにうまく使うことができれば、大きな推進力となります。</span>
                        <span> 火星にハードな配置が多い場合はフラストレーションがたまりやすく、人と争いやすいときかもしれません。火星はうまく扱う意識が大変重要になります。火星のエネルギーを志のためにうまく扱えば、大きな成長を果たすことができるでしょう。</span>
                    </p>
                </div>
        ...
        <div class="page page31 page--cover page--jupiter page--number page--number_right"
            ...
            <div class="page__inner">
                ...
                <div class="page--cover-block1">
                    ...
                    <p class="page__text">
                        <span> 拡大と幸運の星です。ソーラーリターンの木星からは、この一年、あなたがどんなものを得ることができ、どんなチャンスや幸運がもたらされるのかが示されています。</span>
                        <span> 木星は一つの星座に一年ほど滞在するため、星座のテーマからは、その時期に広がること、流行すること、好まれることなどがあらわれています。そのため、あなた以外にも多くの人が該当する内容になります。</span>
                        <span> それに対して、ソーラーリターンの木星のハウス、サビアンシンボル、アスペクトはあなた個人の一年の運勢としてとても重要になります。</span>
        ...
        <div class="page page32 page--content page--jupiter page--number page--number_left"
            ...
            <div class="page__inner">
                ...
                <div class="page-block page-block--2">
                    ...
                    <p class="page__text">
                        <span> あなたのこの一年の幸運にかかわるテーマはサビアンシンボルに具体的にあらわれています。そのような能力を身につけ、社会的に活かせるかもしれませんし、やるとうまくいきやすいことをあらわしていることもあります。そんな意識で見てみましょう。</span>
                    </p>
                </div>
                <div class="page-block page-block--3">
        ...
        <div class="page page35 page--cover page--saturn page--number page--number_right"
            ...
            <div class="page__inner">
                ...
                <div class="page--cover-block1">
                    ...
                    <p class="page__text">
                        <span> あなたがこの一年どんな努力をし何を形にしようとするのか、どのように社会的な役割の基盤を構築するのかをあらわします。努力というとあまりいい気分がしないかもしれませんが、しっかりと目的意識に合わせて努力ができてこそ、社会的な基盤が安定していきます。また、社会的な成功は責任とセットであることは否めないでしょう。
                        </span>
                        <span> 土星は一つの星座に 3年前後滞在するため、その影響は集合意識的なものになります。そのためサインについては、みんなそういう時期なんだな、と思うようにしてください。
                        </span>
        ...
        <div class="page page37 page--content page--saturn page--number page--number_right"
            ...
            <div class="page__inner">
                ...
                <div class="page-block page-block--2">
                    <p class="page-block--2__title">アスペクト<span>他の天体との関わりからわかること</span></p>
                    <p class="page__text">
                        <span> 土星のアスペクトについては、月から木星とのかかわりがある場合には記載済みです。この項目に該当するアスペクトはありません。
                        </span>
                    </p>
                </div>
            </div>
        ...
        <div class="page page--cover page--saturnians page--number page--number_right"
            ...
            <div class="page__inner">
                ...
                <div class="page--cover-block1">
                    <p class="page__text">
                        <span> 太陽の外側にあり、「トランスサタニアン」と呼ばれる天王星、海王星、冥王星は、太陽回帰において、アスペクトのみならずハウスにおいても無意識的で強い影響を与えます。</span>
                        <br>
        ...
        <div class="page page36 page--content page--uranus page--number page--number_left"data-pageno="{{ $page++ }}">
            <div class="page__inner">
                ...
                <div class="page-block page-block--2">
                    ...
                    <p class="page__text">
                        <span style="text-indent: 0;"> あなたが変革したい、生き方を変えたい、新たに取り入れたいことなどについて、その具体的な方向性が天王星のサビアンシンボルにあらわれます。</span>
                    </p>
                </div>
        ...
        <div class="page page36 page--content page--neptune page--number page--number_left"data-pageno="{{ $page++ }}">
            <div class="page__inner">
                ...
                <div class="page-block page-block--2">
                    ...
                    <p class="page__text">
                        <span>あなたが無意識的にどんな理想を描くのかが具体的にあらわれています。また、第六感的な感受性をどんな領域で発揮させるか、どんな感覚が育つかがわかることもあります。</span>
                    </p>
                </div>
                <div class="page-block page-block--3">
        ...
        <div class="page page36 page--content page--pluto page--number page--number_left"data-pageno="{{ $page++ }}">
            <div class="page__inner">
                ...
                <div class="page-block page-block--2">
                    ...
                    <p class="page__text">
                        <span>冥王星は一年をかけてホロスコープ上をわずかしか進まないため、ソーラーリターンでは、多くの人が同じ冥王星のサビアンシンボルを共有します。そのため、より集合意識的な意味が強まります。とはいえ、あなたが深い部分で変えようとしていることや、手に入れようとしている力をあらわしていると考えて読んでみましょう。</span>
                    </p>
                </div>
                <div class="page-block page-block--3">
