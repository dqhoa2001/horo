        ...
        <div class="page page20 page--content page--venus page--number page--number_left"
            ...
            <div class="page__inner">
                ...
                <div class="page-block page-block--2">
                    ...
                    <p class="page__text">
                        <span> 金星のサビアンシンボルからは、あなたのもって生まれた好みや感性の特徴が具体的にわかります。以下のシンボル解説の内容は、「好きなことに関係するテーマ」で発揮されるのだということを頭に入れて読んでいきましょう。また、後の金星のハウスのテーマを通して発揮できる面もあります。</span>
                    </p>
                </div>
                <div class="page-block page-block--3">
        ...
        <div class="page page27 page--cover page--mars page--number page--number_right"
            ...
            <div class="page__inner">
                ...
                <div class="page--cover-block1">
                    ...
                    <p class="page__text">
                        <span> この一年、自分がどんなことに情熱を注ぐか、同時にどんなことに怒りを感じやすいかがあらわれています。生まれたときとは全く違う場所に位置していることが多く、どんなことのために行動し、何を得ようとするのかがわかります。</span>
                        <span>何かを成し遂げるためにうまく使うことができれば、大きな推進力となります。</span>
                        <span> 火星にハードな配置が多い場合はフラストレーションがたまりやすく、人と争いやすいときかもしれません。火星はうまく扱う意識が大変重要になります。</span>
                        <span> 火星のエネルギーを志のためにうまく扱えば、大きな成長を果たすことができるでしょう。</span>
                    </p>
                </div>
            ...
            <div class="page__inner">
                ...
                <div class="page--cover-block1">
                    ...
                    <p class="page__text">
                        ...
                        <span> 木星は一つの星座に一年ほど滞在するため、星座のテーマからは、その時期に広がること、流行すること、好まれることなどがあらわれています。そのため、サインについての記述はあなた以外にも多くの人が該当する内容になります。</span>
