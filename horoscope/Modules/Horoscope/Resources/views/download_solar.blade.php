        ...
        <div class="page page12 page--content page--number page--number_right page--moon"
            ...
            <div class="page__inner">
                ...
                <div class="page-block page-block--2">
                    <p class="page-block--2__title">アスペクト<span>他の天体との関わりからわかること</span></p>
                    <p class="page__text">
                        <span> 暮らしそのものにストレスが多いか、楽しみや癒しが多いかといったことは、月とのアスペクトに表れている場合が多くなります。</span>
                    </p>
                </div>
        ...
        <div class="page page32 page--content page--jupiter page--number page--number_left"
            ...
            <div class="page__inner">
                ...
                <div class="page-block page-block--2">
                    ...
                    <p class="page__text">
                        <span> あなたの今年の幸運にかかわるテーマはサビアンシンボルに具体的にあらわれています。そのような能力を身につけ、社会的に活かせるかもしれませんし、やるとうまくいきやすいことをあらわしていることもあります。そんな意識で見てみましょう。</span>
                    </p>
                </div>
                <div class="page-block page-block--3">
        ...
        <div class="page page33 page--content page--jupiter page--number page--number_right"
            ...
            <div class="page__inner">
                ...
                <div class="page-block page-block--2">
                    <p class="page-block--2__title">アスペクト<span>他の天体との関わりからわかること</span></p>
                    <p class="page__text">
                        <span> 木星と個人天体がかかわると、その天体の意味を拡大させ、幸運につながりますので、非常に重要です。記載済みのものも改めてご覧ください。また、ここに鑑定内容が記載される土星やトランスサタニアンとのアスペクトは時代的な意味が強まりますので、だれにとっても今がそういう時期なのたと理解しましょう。</span>
                    </p>
                </div>
                <div class="page-block page-block--5">
