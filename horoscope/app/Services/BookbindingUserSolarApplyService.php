...
class BookbindingUserSolarApplyService
{
    ...
    public static function createForBookbinding(Request $request, SolarApply $solarApply, ?string $bulkBindingKey = null, ?int $bulkBindingCount = null): BookbindingUserApply
    {
        $bookbindingUserApply = BookbindingUserApply::create([
            ...
            'post_number'        => $request->zip,
            'pref_num'           => $request->pref_num,
            'bookbinding_name1'   => $request->bookbinding_names1[$solarApply->id],
            'bookbinding_name2'   => $request->bookbinding_names2[$solarApply->id],
            'address'            => $request->address,
            'building'           => $request->building,
            'name'               => $request->building_name,
            'tel'                => $request->tel,
            'is_design'          => $request->pdf_types[$solarApply->id],
        ]);
