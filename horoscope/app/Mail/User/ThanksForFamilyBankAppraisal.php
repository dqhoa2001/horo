...
class ThanksForFamilyBankAppraisal extends Mailable implements ShouldQueue
{
    ...
    public function __construct(AppraisalApply $appraisalApply)
    {
        ...
        $this->data = [
            ...
            'family_appraisals_show_url' => route('user.family_appraisals.show', $this->appraisalApply->id),
