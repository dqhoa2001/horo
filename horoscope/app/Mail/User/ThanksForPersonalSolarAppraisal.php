...
class ThanksForPersonalSolarAppraisal extends Mailable implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(AppraisalApply $appraisalApply)
    {
        ...
        $this->data = [
            ...
            'personal_solar_appraisals_show_url' => route('user.solar_appraisals.show', $this->appraisalApply->id),
