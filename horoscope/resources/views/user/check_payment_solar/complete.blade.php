                ...
                <div class="Pageframe-main-content">
                    <section class="sec Offer C-form" id="Offer">
                        <p class="C-form__message C-form-line C-form-line--first">
                            <span class="C-form__message__req">{{ \App\Models\SolarApply::COMPLETE_TARGET_TYPE[(int)$target_type] }}鑑定申し込み完了</span>
                        </p>
                        ...
                        <!--クレジットの場合-->
                        @if((int)$solarApply->solarClaim->payment_type === \App\Models\SolarClaim::CREDIT)
                            <!--家族の場合-->
                            @if((int)$target_type === \App\Enums\TargetType::FAMILY->value)
                                <div class="Button Button--lightblue btn-block-mt">
                                    <a href="{{ route('user.family_appraisals.show', $solarApply->id) }}">
                                        家族の個人鑑定結果はこちら
                                    </a>
                                </div>
                            @else
                                <!--個人の場合-->
                                <div class="Button Button--lightblue btn-block-mt">
                                    <a href="{{ route('user.appraisals.show', $solarApply->id) }}">
                                        個人鑑定結果はこちら
                                    </a>
                                </div>
                            @endif
