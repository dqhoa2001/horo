            ...
            <div class="Pageframe-main__inner">
                <div class="Pageframe-main-content">
                    ...
                    <section class="sec Familyhoroscope Familyhoroscope--create" id="Familyhoroscope--create">
                        ...
                        <p class="Pageframe-main__firstmessage">{{ auth()->guard('user')->user()->name2 }}さんの家族のホロスコープチャートを作成します。<br>大切な人のホロスコープを最大20名までの保存することができます。</p>
                                    ...
                                    <div class="C-horoscope-form__inner">
                                        <dl class="C-horoscope-form-block C-horoscope-form-block--half C-horoscope-form-block--name">
                                            ...
                                            <dd class="C-horoscope-form-block__body">
                                                <div class="C-horoscope-form-field"><input type="text" name="name1" placeholder="山田" value="{{ old('name1') }}" maxlength=10 required></div>
                                                <div class="C-horoscope-form-field"><input type="text" name="name2" placeholder="花子" value="{{ old('name2') }}" maxlength=10 required></div>
                                            </dd>
                                        </dl>
                                        <dl class="C-horoscope-form-block C-horoscope-form-block--zokugara">
                                            <dt class="C-horoscope-form-block__title">続柄</dt>
                                            <dd class="C-horoscope-form-block__body">
                                                <div class="C-horoscope-form-field"><input type="text" name="relationship" placeholder="あなたとの関係"  value="{{ old('relationship') }}" required></div>
                                            </dd>
                                        </dl>
                                            ...
                                            <dl class="C-horoscope-form-block C-horoscope-form-block--birth">
                                                ...
                                                <dd class="C-horoscope-form-block__body">
                                                    <div class="C-horoscope-form-field">
                                                        <input type="date" name="birth" value="{{ old('birth') }}" required max="9999-12-31">
                                                    </div>
                                                </dd>
                                            </dl>
