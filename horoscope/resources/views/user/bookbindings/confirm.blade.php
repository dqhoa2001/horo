			...
			<div class="Pageframe-main__inner">
				<div class="Pageframe-main-content">
					<section class="sec Personal-appraisal C-form" id="bookbindings-confirm">
						...
						<form method="POST" action="{{ route('user.bookbindings.apply') }}" id="bookbindings-confirm-form">
							@csrf

							@foreach($data['appraisal_apply_ids'] as $appraisal_apply_id)
								<input type="hidden" name="appraisal_apply_ids[]" value="{{ $appraisal_apply_id }}">
							@endforeach
