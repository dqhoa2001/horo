                                    ...
                                    <dd class="C-form-notice__inner">
                                        <div class="C-form-notice-content">
                                            <ul class="C-form-notice-content-list">
                                                ...
                                                <li class="C-form-notice-list__item">この鑑定は、あくまでも製作者海部舞による解釈の一つです。鑑定内容に関係なく、人生の責任を負うのも、その決定権があるのも皆様自身であることをご理解ください。</li>
                                                <li class="C-form-notice-list__item">これは皆様の人生のテーマを明らかにし、より可能性を広げるための情報を提供することを目的としています。個人の私利私欲、恋愛や結婚の成就のお役に立つかは保障いたしかねます。</li>
                                                <!-- <li class="C-form-notice-list__item">製本をお申し込みのお客様へ：システムによるエラーや乱丁・落丁はお取替えいたしますが、お客様の出生情報入力ミスによるものは修正・返品ができません。別途製本費用をお支払いいただき作り直しになりますので、あらかじめご了承ください。</li> -->
                                            </ul>
                                        </div>
