                    ...
                    <div class="C-appraisal-content-header__first-message">
                        ...
                        @if ($planet == 'VENUS')
                            <p class="C-appraisal-content-header__first-message__text">
                                ...
                                　ソーラーリターンの場合は太陽があらわす目的意識を成し遂げるために使われる意味として読んでいくため、私生活ではなく仕事でこの感性が活かされるか、仕事で楽しみが多いか、といったことがわかるとと考えます。<br>
                                　社会であなたの魅力的を表現するためにとても重要です。
                            </p>
                        @endif
                        @if ($planet == 'MARS')
                            <p class="C-appraisal-content-header__first-message__text">
                        ...
                        @if ($planet == 'JUPITER')
                            <p class="C-appraisal-content-header__first-message__text">
                                ...
                                　木星は一つの星座に一年ほど滞在するため、星座のテーマからは、その時期に広がること、流行すること、好まれることなどがあらわれています。そのため、12サインについての記述はあなた以外にも多くの人が該当する内容になります。<br>
                        ...
                        @if ($planet == 'SATURN')
                            <p class="C-appraisal-content-header__first-message__text">
                                　あなたがこの一年そんな努力をし何を形にしようとするのか、どのように社会的な役割の基盤を構築するのかをあらわします。努力というとあまりいい気分がしないかもしれませんが、しっかりと目的意識に合わせて努力ができてこそ、社会的な基盤が安定していきます。また、社会的な成功は責任とセットであることは否めないでしょう。<br>
                                　土星は一つの星座に3年前後滞在するため、その影響は集合意識的なものになります。そのため12サインについては、みんなそういう時期なんだな、と思うようにしてください。<br>
                                　個人として重要なのは、サビアンシンボルとハウスになります。
                            </p>
                        @endif
                        @if ($planet == 'URANUS')
                            <p class="C-appraisal-content-header__first-message__text">
                                　この1年で目に見える変化を起こしたり、新しく取り入れること、刷新させるテーマなどがわかります。天王星からの影響で、急な変化や手放しが起こることもありますが、よりあなたらしい生き方に向かっていくきっかけとなるでしょう。
                            </p>
                        @endif
                        @if ($planet == 'NEPTUNE')
                            <p class="C-appraisal-content-header__first-message__text">
                                　この1年の目に見えないものとのつながり、どんな夢や理想を抱くかをあらわします。海王星からの影響で、気持ちが揺らぎやすくなったり、信念や無意識的な感性に変化が起こりやすくもなります。
                            </p>
                        @endif
                        @if ($planet == 'PLUTO')
                            <p class="C-appraisal-content-header__first-message__text">
                        ...
                        @if ($planet == 'NEPTUNE')
                            <dl class="C-appraisal-content-header-message">
                                ...
                                <dd class="C-appraisal-content-header-message__text">
                                    ...
                                    性をどんな領域で発揮させるか、どんな感覚が育つかがわかる、こともあります。
                                </dd>
                            </dl>
                        @endif
                        @if ($planet == 'PLUTO')
                        ...
                        @if ($planet == 'SUN')
                            <dl class="C-appraisal-content-header-message">
                                ...
                                <dd class="C-appraisal-content-header-message__text">
                                    ...
                                    寧に読み解いて、自分がやりたいことと比較し、進むヒントにしてくだささい。
                                </dd>
                            </dl>
                        @endif
                        @if ($planet == 'MOON')
