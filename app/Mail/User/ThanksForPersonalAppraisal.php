...
class ThanksForPersonalAppraisal extends Mailable implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(AppraisalApply $appraisalApply)
    {
        ...
        $this->data = [
            ...
            'personal_appraisals_show_url' => route('user.appraisals.show', $this->appraisalApply->id),
