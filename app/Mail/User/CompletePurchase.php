...
class CompletePurchase extends Mailable implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(AppraisalApply $appraisalApply)
    {
        ...
        // dd($this->appraisalApply->reference->full_name);
        ...
        // テンプレートからメール本文を生成
        $this->data = [
            'full_name' => $this->appraisalApply->reference->full_name,
