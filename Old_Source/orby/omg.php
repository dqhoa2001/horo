...
// error_log(__DIR__."/swetest -edir\"".__DIR__."/$sweph\" -b$utdatenow -ut$utnow -p0123456789DAttt -eswe -house$my_longitude,$my_latitude,$h_sys -flsj -g, -head");
      ...
      $eeexec = __DIR__."/swetest64 -edir\"".__DIR__."/$sweph\" -b$utdatenow -ut$utnow -p0123456789tDAtt -eswe -house$my_longitude,$my_latitude,$h_sys -flsj -g, -head >& errorlog";
      
      // exec (__DIR__."/swetest -edir\"".__DIR__."/$sweph\" -b$utdatenow -ut$utnow -p0123456789tDAtt -eswe -house$my_longitude,$my_latitude,$h_sys -flsj -g, -head > error.log", $out, $retvar);
      echo exec ($eeexec, $out, $retvar);

//      echo "<pre>command = $eeexec; </pre>";
//      echo "<pre>retvar = $retvar</pre>";
...
// no need to urlencode unless perhaps magic quotes is ON (??)
      ...
      <ul>
      	<?php 
      	foreach ($longitude1 as $lll) {
      	?>
      	<li>
      		longitude = <?php echo $lll; ?>
      	</li>
      	<?php
    	}
    	?>
      	<li>
      		SE_TNODE = <?php echo SE_TNODE; ?>
      	</li>
      	<li>
      		rx1 = <?php echo $rx1; ?>
      	</li>
      	...
      	<li>
      		ser L1 = <?php echo $ser_L1; ?>
      	</li>
      	<li>
      		ser L2 = <?php echo $ser_L2; ?>
      	</li>
      	<li>
      		ubt1 = <?php echo $ubt1; ?>
      	</li>
      ...
      <center>
      	<?php 
      		echo "<img border='0' src='http://dp50195346.lolipop.jp/autrium/wp-content/plugins/orby/chart.php?rx1=$rx1&rx2=$rx2&p1=$ser_L1&p2=$ser_L2&hc1=$ser_hc1&ubt1=$ubt1&ubt2=$ubt2&bg=$useBg' style='max-width:800px;'>";
      	?>
      </center>
...
<form id="natalform"  action="<?php echo function_exists('plugins_url') ? plugins_url('omg.php',__FILE__) : 'omg.php'; ?>" method="post" style="margin: 0px 20px;">
