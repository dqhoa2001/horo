							...
							<div class="C-appraisal-item">
								...
								<div class="C-appraisal-item-entry">
									...
									<div class="Button Button--blue2"><a
											href="{{ route('user.appraisals.personalAppraisal') }}">個人鑑定に申し込む</a></div>
								</div>
							</div>

							<figure class="C-appraisal-banner">
								<a href="{{ route('user.bookbindings.create') }}">
									<img
										src="{{ asset('mypage/assets/images/my/img_bookbanner.png') }}"
								...
								<div class="C-appraisal-history__inner">
									...
									<div class="C-appraisal-history-block">
										<a href="{{ route('user.appraisals.showPersonalAppraisal', $appraisalApply) }}">
											<time class="C-appraisal-history-block__time" datetime="{{ $appraisalApply->birthday->format('Y.m.d') }}">{{ $appraisalApply->birthday->format('Y.m.d') }}</time>
