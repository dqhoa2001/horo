<x-layout>
    ...
    <x-table>
                ...
                @foreach ($zodiacPatterns as $index => $pattern)
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                            <a href={{ route('dashboard.pattern.zodiac-view', $pattern->id) }}>
                            ...
                            <button type="button" class="btn btn-danger mx-1" data-bs-toggle="modal"
                                ...
                                data-action={{ $action = route('dashboard.pattern.zodiac-delete', $pattern->id) }}>
        ...
        {{-- <x-slot name='paginate'>
            @include('includes.paginate', ['paginate' => $zodiacPatterns])
        </x-slot> --}}
    </x-table>
</div>
</div>
